...
let globalConfiguration: DatabaseConfiguration = {
...
export const setConfiguration = (configuration: DatabaseConfiguration) => (globalConfiguration = configuration)

// ---- MySQL Setup ---- //
const createConnection = () => {
  return mysql.createConnection(globalConfiguration);
}
